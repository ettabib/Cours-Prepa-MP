...
%ouvert de \mathbb{R}}\^{}{n}, f : U \longrightarrow F. Soit V un ouvert de {\mathbb{R}}\^{}{p
%et g =
%(g_1},+{\ldots{}}},{g_n)
%: V \longrightarrow U \subset \mathbb{R}}\^{}{n. Soit a \in V et j \in {[}1,p{]}. Si g admet en a
...
%
% \partial(f ∘ g) \over \partial{x_j} (a) ={
%\mathop\sum }_i=1}\^{}{n{ \partialf
%\over \partialy_i}} (g(a)){ \partial{g_i
%\over \partialx_j} (a)
%
