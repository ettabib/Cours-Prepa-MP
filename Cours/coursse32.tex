...
% notera \mathcal{F}a,A(E) l'ensemble des fonctions de \mathbb{R}~ vers E telles
% qu'il existe V \in V (a) tel que f soit définie sur V \bigcap A (autrement dit f
% est définie sur A au voisinage de a).

% Exemple~6.1.1 Si A = \mathbb{N}~ et a = +\infty~, \mathcal{F}a,A(E) est l'ensemble des
% suites (xn)n\geqn0 d'éléments de E.
...
% \item
%   (iii) soit \phi,\psi \in\mathcal{F}a,A(K) et f,g \in\mathcal{F}a,A(E), alors
...
%   \end{align*}
% \item
%   (iv) f \in\mathcal{F}a,A(E),g \in\mathcal{F}a,A(F),h \in\mathcal{F}a,A(G)~;
%   alors
...
% Lemme~6.1.2 Soit f,g \in\mathcal{F}a,A(E). Alors f - g = o(g) \rigtharrow~ g = O(f).
...
% Théorème~6.1.3 Pour f,g \in\mathcal{F}a,A(E), on pose f ∼ g si f - g =
...
% \item
%   (ii) \phi,\psi \in\mathcal{F}a,A(K), f,g \in\mathcal{F}a,A(E), alors \phi ∼
...
% \begin{itemize}
% \item
%   (i) si f,g \in\mathcal{F}a,A(K) et n \in \mathbb{N}~, alors f ∼ g \rigtharrow~ f^n ∼
%   g^n
% \item
%   (ii) si f,g \in\mathcal{F}a,A(\mathbb{R}~) et s'il existe V \in V (a) tel que
%   \forall~~t \in V \bigcap A, g(t) \geq 0 (resp. \textgreater{}
%   0) alors
...
% Théorème~6.1.7 Soit f,g \in\mathcal{F}a,A(E) telles que f ∼ g. Si g admet
...
% Théorème~6.1.9 Soit f,g \in\mathcal{F}b,B(E). Alors
